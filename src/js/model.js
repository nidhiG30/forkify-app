...
export const loadSearchResults = async function(query) { // func performs AJAX calls, that's why async
  try{
...
export const addBookmark = function(recipe) { // takes a recipe to get bookmarked
  // Add bookmark
